...
export class CategoryService  {
 ...
 createPhysicalTreatmentCategory(category: PhysicalTreatmentCategory): Observable<PhysicalTreatmentCategory>{
...
addTreatmentToCategory(categoryId: number, physicalTreatment: PhysicalTreatment): Observable<PhysicalTreatment> {
